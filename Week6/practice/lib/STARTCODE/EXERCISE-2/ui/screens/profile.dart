...
import 'package:testing/STARTCODE/EXERCISE-2/model/profile_tile_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: profileData.tiles.length + 1, // plus 1 here to get the last index display
        itemBuilder: (context, index) {
          if (index == 0) {
            // if index equal to zero, it will return center widget and end the loop (index 0) 
            //and start a new index which is 1. Therefore, that ProfileTile at index 0 wont be able to display
            return Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
